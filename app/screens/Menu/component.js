...
import BurgerHeader from '../../components/elements/BurgerHeader';
...
export default class Component extends React.Component {
  ...
  _onPress11 = () => {
    this.props.navigation.navigate('QuestionMenu');
  };
        ...
        <ScrollView>
          <View style={styles.titleContainer}>
            <View style={styles.backContainer}>
              <BurgerHeader containerStyle={{ backgroundColor: '#5D8CEC' }} />
